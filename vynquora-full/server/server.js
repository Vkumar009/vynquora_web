    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:auto;padding:32px;background:#060b24;border-radius:12px;color:#e8ecff">
          <img src="cid:logo" alt="Vynquora" style="width:60px;height:60px;border-radius:50%;margin-bottom:20px"/>
          ...
          <p style="color:#8b9bc5;line-height:1.7">— The Vynquora Team</p>
        </div>
      `,
    })
